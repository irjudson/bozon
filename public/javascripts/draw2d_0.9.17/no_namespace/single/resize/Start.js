...
Start.prototype.setWorkflow=function(_3251){
Node.prototype.setWorkflow.call(this,_3251);
if(_3251!=null){
this.outputPort1=new OutputPort();
this.outputPort1.setMaxFanOut(1);
this.outputPort1.setWorkflow(_3251);
...
this.outputPort2.setWorkflow(_3251);
