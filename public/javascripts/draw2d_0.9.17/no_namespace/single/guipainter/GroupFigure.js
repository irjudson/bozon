...
GroupFigure.prototype.onFigureEnter=function(_397f){
if(this.children[_397f.id]==null){
this.setBackgroundColor(this.highlightBackgroundColor);
}
CompartmentFigure.prototype.onFigureEnter.call(this,_397f);
};
GroupFigure.prototype.onFigureLeave=function(_3980){
CompartmentFigure.prototype.onFigureLeave.call(this,_3980);
this.setBackgroundColor(this.defaultBackgroundColor);
};
GroupFigure.prototype.onFigureDrop=function(_3981){
CompartmentFigure.prototype.onFigureDrop.call(this,_3981);
this.setBackgroundColor(this.defaultBackgroundColor);
};
