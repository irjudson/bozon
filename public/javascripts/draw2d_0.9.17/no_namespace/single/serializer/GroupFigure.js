...
GroupFigure.prototype.onFigureEnter=function(_3c55){
if(this.children[_3c55.id]==null){
this.setBackgroundColor(this.highlightBackgroundColor);
}
CompartmentFigure.prototype.onFigureEnter.call(this,_3c55);
};
GroupFigure.prototype.onFigureLeave=function(_3c56){
CompartmentFigure.prototype.onFigureLeave.call(this,_3c56);
this.setBackgroundColor(this.defaultBackgroundColor);
};
GroupFigure.prototype.onFigureDrop=function(_3c57){
CompartmentFigure.prototype.onFigureDrop.call(this,_3c57);
this.setBackgroundColor(this.defaultBackgroundColor);
};
