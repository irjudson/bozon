...
Start.prototype.setWorkflow=function(_30f8){
ImageFigure.prototype.setWorkflow.call(this,_30f8);
if(_30f8!=null&&this.outputPort==null){
this.outputPort1=new OutputPort();
this.outputPort1.setWorkflow(_30f8);
...
this.outputPort2.setWorkflow(_30f8);
...
this.outputPort3.setWorkflow(_30f8);
...
this.outputPort4.setWorkflow(_30f8);
