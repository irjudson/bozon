...
RoundCornerFigure.prototype.setContent=function(_42b6){
this.textarea.innerHTML=_42b6;
};
RoundCornerFigure.prototype.onDragstart=function(x,y){
var _42b9=Node.prototype.onDragstart.call(this,x,y);
if(this.header==null){
return false;
}
...
RoundCornerFigure.prototype.setWorkflow=function(_42bb){
Node.prototype.setWorkflow.call(this,_42bb);
if(_42bb!=null&&this.inputPort==null){
this.inputPort=new InputPort();
this.inputPort.setWorkflow(_42bb);
this.inputPort.setName("input");
this.addPort(this.inputPort,-5,this.height/2);
this.outputPort=new OutputPort();
this.outputPort.setMaxFanOut(5);
this.outputPort.setWorkflow(_42bb);
