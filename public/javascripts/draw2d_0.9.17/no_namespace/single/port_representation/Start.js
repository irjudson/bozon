...
Start.prototype.setWorkflow=function(_4631){
ImageFigure.prototype.setWorkflow.call(this,_4631);
if(_4631!=null&&this.outputPort==null){
this.outputPort1=new OutputPort(new ImageFigure("port1.png"));
this.outputPort1.setMaxFanOut(1);
this.outputPort1.setWorkflow(_4631);
...
this.outputPort2.setWorkflow(_4631);
