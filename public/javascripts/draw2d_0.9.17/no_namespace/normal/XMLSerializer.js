...
XMLSerializer.toXML=function(obj, objectName, indentSpace)
{
   ...
   switch(t)
   {
      ...
      case "array":
         ...
         {
            s += XMLSerializer.toXML(obj[i], ('index' + i ), indentSpace + "   ");
         }
         s += indentSpace;
         break;
      default:
         if(obj!=null)
         {
            ...
            {
               s += XMLSerializer.toXML(attributes[name], name, indentSpace + "   ");
            }
            s += indentSpace;
         }
      break;
